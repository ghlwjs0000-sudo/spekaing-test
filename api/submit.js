...
// 기존 teacher_approved_sentences 보존
    ...
    const payload = {
     ...
     ppt_url: pptDataUrl || null,
      ...
      worksheet_filename: worksheetFilename || existingData.worksheet_filename || null,
      worksheet_submitted_at: worksheetDataUrl ? (req.body.worksheetSubmittedAt || new Date().toISOString()) : (existingData.worksheet_submitted_at || null),
